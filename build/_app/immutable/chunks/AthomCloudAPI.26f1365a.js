...
let APIError$3 = class APIError2 extends Error {
  /**
   *
...
let APIErrorTimeout$1 = class APIErrorTimeout2 extends APIError$2 {
...
function requireSocket_ioParser() {
  ...
  (function(exports) {
    ...
    function encodeAsBinary(obj2, callback) {
      ...
      binary2.removeBlobs(obj2, writeEncoding);
    }
    function Decoder() {
    ...
    Decoder.prototype.add = function(obj2) {
      ...
      } else if (isBuf(obj2) || obj2.base64) {
        if (!this.reconstructor) {
...
function requireXmlhttprequest_browser() {
  ...
  var globalThis2 = requireGlobalThis_browser();
...
function requireKeys() {
  if (hasRequiredKeys)
    return keys;
  hasRequiredKeys = 1;
  keys = Object.keys || function keys2(obj2) {
    var arr = [];
...
function requireParseqs() {
  ...
  parseqs.encode = function(obj2) {
    var str = "";
    for (var i in obj2) {
      if (obj2.hasOwnProperty(i)) {
        if (str.length)
          str += "&";
        str += encodeURIComponent(i) + "=" + encodeURIComponent(obj2[i]);
      }
    }
    return str;
  };
...
function requireComponentBind() {
  ...
  var slice = [].slice;
  componentBind = function(obj2, fn) {
    if ("string" == typeof fn)
      fn = obj2[fn];
...
function requireManager$2() {
  ...
  function Manager2(uri, opts) {
    if (!(this instanceof Manager2))
      return new Manager2(uri, opts);
    if (uri && "object" === typeof uri) {
      opts = uri;
      uri = void 0;
    }
  ...
  Manager2.prototype.emitAll = function() {
  ...
  Manager2.prototype.updateSocketIds = function() {
    for (var nsp in this.nsps) {
      if (has.call(this.nsps, nsp)) {
  ...
  Manager2.prototype.generateId = function(nsp) {
    return (nsp === "/" ? "" : nsp + "#") + this.engine.id;
  };
  Emitter(Manager2.prototype);
  Manager2.prototype.reconnection = function(v) {
    if (!arguments.length)
      return this._reconnection;
    this._reconnection = !!v;
    return this;
  };
  Manager2.prototype.reconnectionAttempts = function(v) {
    if (!arguments.length)
      return this._reconnectionAttempts;
    this._reconnectionAttempts = v;
    return this;
  };
  Manager2.prototype.reconnectionDelay = function(v) {
    if (!arguments.length)
  ...
  Manager2.prototype.randomizationFactor = function(v) {
    if (!arguments.length)
  ...
  Manager2.prototype.reconnectionDelayMax = function(v) {
    if (!arguments.length)
  ...
  Manager2.prototype.timeout = function(v) {
    if (!arguments.length)
      return this._timeout;
    this._timeout = v;
    return this;
  };
  Manager2.prototype.maybeReconnectOnOpen = function() {
    if (!this.reconnecting && this._reconnection && this.backoff.attempts === 0) {
      this.reconnect();
    }
  };
  Manager2.prototype.open = Manager2.prototype.connect = function(fn, opts) {
  ...
  Manager2.prototype.onopen = function() {
    debug2("open");
    this.cleanup();
    this.readyState = "open";
    this.emit("open");
  ...
  Manager2.prototype.onping = function() {
    this.lastPing = /* @__PURE__ */ new Date();
    this.emitAll("ping");
  };
  Manager2.prototype.onpong = function() {
    this.emitAll("pong", /* @__PURE__ */ new Date() - this.lastPing);
  };
  Manager2.prototype.ondata = function(data) {
    this.decoder.add(data);
  };
  Manager2.prototype.ondecoded = function(packet) {
    this.emit("packet", packet);
  };
  Manager2.prototype.onerror = function(err) {
    debug2("error", err);
    this.emitAll("error", err);
  };
  Manager2.prototype.socket = function(nsp, opts) {
  ...
  Manager2.prototype.destroy = function(socket2) {
  ...
  Manager2.prototype.packet = function(packet) {
  ...
  Manager2.prototype.processPacketQueue = function() {
    if (this.packetBuffer.length > 0 && !this.encoding) {
      var pack = this.packetBuffer.shift();
      this.packet(pack);
    }
  };
  Manager2.prototype.cleanup = function() {
    debug2("cleanup");
  ...
  Manager2.prototype.close = Manager2.prototype.disconnect = function() {
    debug2("disconnect");
  ...
  Manager2.prototype.onclose = function(reason) {
    debug2("onclose");
    this.cleanup();
    this.backoff.reset();
    this.readyState = "closed";
  ...
  Manager2.prototype.reconnect = function() {
  ...
  Manager2.prototype.onreconnect = function() {
  ...
  (function(module, exports) {
    ...
    function lookup(uri, opts) {
      ...
      if (newConnection) {
        ...
        io = Manager2(source, opts);
      } else {
        if (!cache[id]) {
          debug2("new io instance for %s", source);
          cache[id] = Manager2(source, opts);
        }
        io = cache[id];
      }
...
function requireAPIErrorHomeyOffline() {
  ...
  class APIErrorHomeyOffline2 extends APIError3 {
    constructor(err) {
  ...
  APIErrorHomeyOffline_1 = APIErrorHomeyOffline2;
  return APIErrorHomeyOffline_1;
}
var HomeyAPIError_1;
...
function requireHomeyAPIError() {
  ...
  const APIError3 = APIError_1;
  class HomeyAPIError2 extends APIError3 {
    constructor({
      error,
  ...
  HomeyAPIError_1 = HomeyAPIError2;
  return HomeyAPIError_1;
}
var EventEmitter_1;
...
function requireItem() {
  if (hasRequiredItem)
    return Item_1;
  hasRequiredItem = 1;
  const EventEmitter2 = requireEventEmitter();
  class Item extends EventEmitter2 {
...
function requireManagerApps() {
  ...
  const Manager2 = requireManager$1();
  const App = requireApp();
  const _ManagerApps = class extends Manager2 {
  };
  let ManagerApps2 = _ManagerApps;
  __publicField(ManagerApps2, "CRUD", {
    ...__superGet(_ManagerApps, _ManagerApps, "CRUD"),
    App
  });
  ManagerApps_1 = ManagerApps2;
  return ManagerApps_1;
}
var Driver_1$1;
...
function requireManagerDrivers$1() {
  ...
  const _ManagerDrivers = class extends Manager2 {
  };
  let ManagerDrivers2 = _ManagerDrivers;
  __publicField(ManagerDrivers2, "CRUD", {
    ...__superGet(_ManagerDrivers, _ManagerDrivers, "CRUD"),
    Driver,
    PairSession
  });
  ManagerDrivers_1$1 = ManagerDrivers2;
  return ManagerDrivers_1$1;
}
var Capability_1$1;
...
function requireDeviceCapability() {
  ...
  const Util3 = Util_1;
  const EventEmitter2 = requireEventEmitter();
  class DeviceCapability extends EventEmitter2 {
    constructor({
      id,
      device,
      listener
...
function requireManagerDevices$1() {
  ...
  const _ManagerDevices = class extends Manager2 {
  };
  let ManagerDevices2 = _ManagerDevices;
  __publicField(ManagerDevices2, "CRUD", {
    ...__superGet(_ManagerDevices, _ManagerDevices, "CRUD"),
    Capability,
    Device: Device3
  });
  ManagerDevices_1$1 = ManagerDevices2;
  return ManagerDevices_1$1;
}
var Flow_1$1;
...
function requireManagerFlow$1() {
  ...
  const _ManagerFlow = class extends Manager2 {
  };
  let ManagerFlow2 = _ManagerFlow;
  __publicField(ManagerFlow2, "CRUD", {
...
function requireManagerFlowToken$1() {
  ...
  const _ManagerFlowToken = class extends Manager2 {
  };
  let ManagerFlowToken2 = _ManagerFlowToken;
  __publicField(ManagerFlowToken2, "CRUD", {
    ...__superGet(_ManagerFlowToken, _ManagerFlowToken, "CRUD"),
    FlowToken
  });
  ManagerFlowToken_1$1 = ManagerFlowToken2;
  return ManagerFlowToken_1$1;
}
var Log_1$1;
...
function requireManagerInsights$1() {
  ...
  const _ManagerInsights = class extends Manager2 {
  };
  let ManagerInsights2 = _ManagerInsights;
  __publicField(ManagerInsights2, "CRUD", {
    ...__superGet(_ManagerInsights, _ManagerInsights, "CRUD"),
    Log
  });
  ManagerInsights_1$1 = ManagerInsights2;
  return ManagerInsights_1$1;
}
const managers$2 = {
  ManagerAlarms: {
...
function requireManagerFlowToken() {
  ...
  ManagerFlowToken_1 = ManagerFlowToken2;
  return ManagerFlowToken_1;
}
var Capability_1;
...
function requireManagerDevices() {
  ...
  ManagerDevices_1 = ManagerDevices2;
  return ManagerDevices_1;
}
var Driver_1;
...
function requireManagerDrivers() {
  ...
  ManagerDrivers_1 = ManagerDrivers2;
  return ManagerDrivers_1;
}
var browser;
...
function requireManager() {
  ...
  class Manager2 extends HomeyAPIV3Manager {
  }
  Manager_1 = Manager2;
  return Manager_1;
}
...
function requireManagerDevkit$1() {
  ...
  class ManagerDevkit extends Manager2 {
    /**
...
function requireManagerInsights() {
  ...
  ManagerInsights_1 = ManagerInsights2;
  return ManagerInsights_1;
}
var HomeyAPIV2_1;
...
function requireHomeyAPIV2() {
  ...
  const ManagerFlow2 = requireManagerFlow();
  const ManagerFlowToken2 = requireManagerFlowToken();
  const ManagerDevices2 = requireManagerDevices();
  const ManagerDrivers2 = requireManagerDrivers();
  const ManagerDevkit = requireManagerDevkit();
  const ManagerInsights2 = requireManagerInsights();
  ...
  async onCallRequestPrepare({ request }) {
    ...
    if (request.query) {
      if (Object.keys(request.query).length) {
        request.url += `?${Util$1.stringifyQuery(request.query)}`;
      }
    }
...
let Device$1 = class Device2 extends APIDefinition$1 {
  /**
   * @type string
   */
  get id() {
