...
var browserExports$1 = browser$4.exports;
...
(function(exports) {
  ...
  function isPayloadValid(type, payload) {
    switch (type) {
      ...
      case 2:
      case 5:
        return isArray2(payload) && (typeof payload[0] === "string" || typeof payload[0] === "number");
      case 3:
      case 6:
        return isArray2(payload);
    }
  }
...
function Manager$b(uri, opts) {
  if (!(this instanceof Manager$b))
    return new Manager$b(uri, opts);
  if (uri && "object" === typeof uri) {
    opts = uri;
    uri = void 0;
  }
...
Manager$b.prototype.emitAll = function() {
...
Manager$b.prototype.updateSocketIds = function() {
  for (var nsp in this.nsps) {
    if (has.call(this.nsps, nsp)) {
...
Manager$b.prototype.generateId = function(nsp) {
  return (nsp === "/" ? "" : nsp + "#") + this.engine.id;
};
Emitter(Manager$b.prototype);
Manager$b.prototype.reconnection = function(v) {
  if (!arguments.length)
    return this._reconnection;
  this._reconnection = !!v;
  return this;
};
Manager$b.prototype.reconnectionAttempts = function(v) {
  if (!arguments.length)
    return this._reconnectionAttempts;
  this._reconnectionAttempts = v;
  return this;
};
Manager$b.prototype.reconnectionDelay = function(v) {
  if (!arguments.length)
...
Manager$b.prototype.randomizationFactor = function(v) {
  if (!arguments.length)
...
Manager$b.prototype.reconnectionDelayMax = function(v) {
  if (!arguments.length)
...
Manager$b.prototype.timeout = function(v) {
  if (!arguments.length)
    return this._timeout;
  this._timeout = v;
  return this;
};
Manager$b.prototype.maybeReconnectOnOpen = function() {
  if (!this.reconnecting && this._reconnection && this.backoff.attempts === 0) {
    this.reconnect();
  }
};
Manager$b.prototype.open = Manager$b.prototype.connect = function(fn, opts) {
...
Manager$b.prototype.onopen = function() {
  debug("open");
  this.cleanup();
  this.readyState = "open";
  this.emit("open");
...
Manager$b.prototype.onping = function() {
  this.lastPing = /* @__PURE__ */ new Date();
  this.emitAll("ping");
};
Manager$b.prototype.onpong = function() {
  this.emitAll("pong", /* @__PURE__ */ new Date() - this.lastPing);
};
Manager$b.prototype.ondata = function(data) {
  this.decoder.add(data);
};
Manager$b.prototype.ondecoded = function(packet) {
  this.emit("packet", packet);
};
Manager$b.prototype.onerror = function(err) {
  debug("error", err);
  this.emitAll("error", err);
};
Manager$b.prototype.socket = function(nsp, opts) {
...
Manager$b.prototype.destroy = function(socket2) {
...
Manager$b.prototype.packet = function(packet) {
...
Manager$b.prototype.processPacketQueue = function() {
  if (this.packetBuffer.length > 0 && !this.encoding) {
    var pack = this.packetBuffer.shift();
    this.packet(pack);
  }
};
Manager$b.prototype.cleanup = function() {
  debug("cleanup");
...
Manager$b.prototype.close = Manager$b.prototype.disconnect = function() {
  debug("disconnect");
...
Manager$b.prototype.onclose = function(reason) {
  debug("onclose");
  this.cleanup();
  this.backoff.reset();
  this.readyState = "closed";
...
Manager$b.prototype.reconnect = function() {
...
Manager$b.prototype.onreconnect = function() {
...
let APIError$6 = class APIError extends Error {
  /**
   *
...
var APIError_1 = APIError$6;
const APIError$5 = APIError_1;
class APIErrorHomeyOffline extends APIError$5 {
  constructor(err) {
...
let Util$6 = class Util {
   ...
   * @returns {Promise<any>}
   */
  static async fetch(url2, options, timeoutDuration, timeoutMessage) {
    options = { ...options };
    ...
    if (this.isReactNative()) {
      responsePromise = fetch(url2, options);
    } else if (this.isBrowser()) {
      responsePromise = window.fetch(url2, options);
    } else if (this.isNodeJS()) {
      const fetch2 = requireBrowser();
      responsePromise = fetch2(url2, options);
    ...
    try {
      ...
      if (err.name === "AbortError") {
        if (options.signal && options.signal.aborted && options.signal.reason === "Timeout") {
          throw new APIErrorTimeout2(timeoutMessage ?? `Timeout after ${timeoutDuration}ms`);
        }
      }
      throw err;
    } finally {
...
let HomeyAPIError$1 = class HomeyAPIError extends APIError$3 {
  constructor({
    error,
...
let Item$c = (_a = class extends EventEmitter$2 {
  ...
  __update(properties) {
    ...
    this.__lastUpdated = /* @__PURE__ */ new Date();
...
const Item$b = Item_1;
let Manager$a = (_b = class extends EventEmitter$1 {
  constructor({ homey, items, operations: operations2 }) {
    super();
    Object.defineProperty(this, "__homey", {
      value: homey,
      enumerable: false,
        ...
        this[operationId] ? `__super__${operationId}` : operationId,
        {
          value: async ({
            ...
            if (Object.keys(query).length > 0) {
              const queryString = Util$5.serializeQueryObject(query);
  ...
  async __request({ $cache, $updateCache, $timeout, $socket, operationId, operation, path, body, headers, shouldRetry, ...args }) {
    let result;
    const benchmark = Util$5.benchmark();
...
var Manager_1$1 = Manager$a;
const Item$a = Item_1;
let Flow$3 = class Flow extends Item$a {
  /**
...
var Flow_1$1 = Flow$3;
const Item$9 = Item_1;
let AdvancedFlow$3 = class AdvancedFlow extends Item$9 {
  /**
   * Check whether this Flow misses one or more {@link FlowCard} or {@link FlowToken}.
   * @returns Promise<Boolean> - A boolean whether this Flow is broken.
   */
...
const Item$8 = Item_1;
let FlowCard$3 = class FlowCard extends Item$8 {
  static transformGet(item) {
...
let ManagerFlow$1 = (_c = class extends Manager$9 {
...
const _ManagerFlow = class _ManagerFlow extends ManagerFlowV3 {
  async createFlow({
    flow,
    ...props
  }) {
...
__publicField(_ManagerFlow, "CRUD", {
...
const Item$7 = Item_1;
let FlowToken$3 = class FlowToken extends Item$7 {
  static transformGet(item) {
    item = super.transformGet(item);
    if (item.uri) {
      item.id = `${item.uri}:${item.id}`;
...
let ManagerFlowToken$1 = (_d = class extends Manager$8 {
...
const _ManagerFlowToken = class _ManagerFlowToken extends ManagerFlowTokenV3 {
  async getFlowToken({
    $cache = true,
    id
  }) {
...
__publicField(_ManagerFlowToken, "CRUD", {
...
let DeviceCapability$1 = class DeviceCapability extends EventEmitter2 {
  ...
  async setValue(value, opts) {
    const transactionId = `homey-api-${Util$4.uuid()}`;
...
let Device$5 = class Device extends Item$5 {
  ...
  async __setCapabilityValue({
    ...
    value,
    opts,
    transactionId = `homey-api-${Util$3.uuid()}`,
...
const Util$2 = Util_1;
let ManagerDevices$1 = (_e = class extends Manager$7 {
  scheduleRefresh() {
    ...
    this.__refreshTimeout = setTimeout(() => {
      if (this.isConnected()) {
        ...
        this.__pendingRefreshDevicesCall = this.getDevices({ $cache: false, $updateCache: false }).then((devices) => {
          ...
          for (const device of Object.values(devices)) {
            ...
            if (cachedDevice != null) {
              Object.entries(cachedDevice.__capabilityInstances).forEach(([capabilityId, capabilityInstances]) => {
                const value = device.capabilitiesObj ? device.capabilitiesObj[capabilityId] != null ? device.capabilitiesObj[capabilityId].value : null : null;
                const lastUpdated = device.capabilitiesObj ? device.capabilitiesObj[capabilityId] != null ? device.capabilitiesObj[capabilityId].lastUpdated : null : null;
...
const _ManagerDevices = class _ManagerDevices extends ManagerDevicesV3 {
};
__publicField(_ManagerDevices, "CRUD", {
...
const Item$4 = Item_1;
let Driver$3 = class Driver extends Item$4 {
  get uri() {
...
const Item$3 = Item_1;
let PairSession$3 = class PairSession extends Item$3 {
  static transformGet(item) {
    item = super.transformGet(item);
    delete item.uri;
    return item;
...
let ManagerDrivers$1 = (_f = class extends Manager$6 {
...
const _ManagerDrivers = class _ManagerDrivers extends ManagerDriversV3 {
  async getDriver({
    $cache = true,
    id
  }) {
...
__publicField(_ManagerDrivers, "CRUD", {
...
let Manager$5 = class Manager extends HomeyAPIV3Manager {
};
var Manager_1 = Manager$5;
const FormData = browser;
const Manager$4 = Manager_1;
let ManagerDevkit$1 = class ManagerDevkit extends Manager$4 {
  /**
...
const Item$2 = Item_1;
let Log$3 = class Log extends Item$2 {
  async getEntries() {
...
const Log3 = Log_1;
const _ManagerInsights = class _ManagerInsights extends ManagerInsightsV3 {
  async getLog({
    $cache = true,
    id
  }) {
...
__publicField(_ManagerInsights, "CRUD", {
...
function requireHomeyAPIV2() {
  ...
  const _HomeyAPIV2 = class _HomeyAPIV2 extends HomeyAPIV3 {
    get platform() {
      return "local";
    }
    get platformVersion() {
  ...
  __publicField(_HomeyAPIV2, "DEFAULT_TIMEOUT", 1e3 * 30);
  __publicField(_HomeyAPIV2, "MANAGERS", {
...
function requireHomeyAPIV3Cloud() {
  ...
  const HomeyAPIV3 = requireHomeyAPIV3();
  const _HomeyAPIV3Cloud = class _HomeyAPIV3Cloud extends HomeyAPIV3 {
    constructor({
      strategy = [
   ...
   */
  __publicField(_HomeyAPIV3Cloud, "DISCOVERY_STRATEGIES", {
    CLOUD: "cloud"
  });
...
function requireHomeyAPI() {
  ...
  const Util3 = Util_1;
  const EventEmitter3 = EventEmitter_1;
  const tierCache = {};
  const versionCache = {};
  class HomeyAPI2 extends EventEmitter3 {
    constructor({
      api = null,
      properties = {},
      debug: debug2 = () => {
...
const Item$1 = Item_1;
let App$1 = class App extends Item$1 {
  /**
...
const App2 = App_1;
const _ManagerApps = class _ManagerApps extends Manager$2 {
};
__publicField(_ManagerApps, "CRUD", {
  ...__superGet(_ManagerApps, _ManagerApps, "CRUD"),
  App: App2
});
let ManagerApps = _ManagerApps;
var ManagerApps_1 = ManagerApps;
const Manager$1 = Manager_1$1;
class ManagerUsers extends Manager$1 {
  constructor() {
    super(...arguments);
...
const Item = Item_1;
let Zone$1 = class Zone extends Item {
  /**
   * Get the parent zone.
...
var Zone_1 = Zone$1;
const Manager2 = Manager_1$1;
const Zone2 = Zone_1;
const _ManagerZones = class _ManagerZones extends Manager2 {
};
__publicField(_ManagerZones, "CRUD", {
  ...__superGet(_ManagerZones, _ManagerZones, "CRUD"),
  Zone: Zone2
});
let ManagerZones = _ManagerZones;
var ManagerZones_1 = ManagerZones;
const managers$1 = {
  ManagerAlarms: {
    id: "alarms",
    idCamelCase: "alarms",
...
function requireHomeyAPIV3() {
  ...
  const ManagerZones2 = ManagerZones_1;
  ...
  class HomeyAPIV3 extends HomeyAPI2 {
    constructor({
      ...
      super({ properties, api, debug: debug2 });
      this.__refreshMap = {};
    ...
    async discoverBaseUrl() {
      ...
      const ping = async (strategyId, timeout) => {
        ...
        const response = await Util3.fetch(
      ...
      if (urls[HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL_SECURE]) {
        ...
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL_SECURE].catch((err) => {
          this.__debug(`Ping ${HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL_SECURE} Error:`, err && err.message);
          this.__debug(urls[HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL_SECURE]);
        });
      }
      if (urls[HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL]) {
        ...
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL].catch(
          (err) => this.__debug(`Ping ${HomeyAPI2.DISCOVERY_STRATEGIES.LOCAL} Error:`, err && err.message)
        );
      }
      if (urls[HomeyAPI2.DISCOVERY_STRATEGIES.MDNS]) {
        ...
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.MDNS].catch(
          (err) => this.__debug(`Ping ${HomeyAPI2.DISCOVERY_STRATEGIES.MDNS} Error:`, err && err.message)
        );
      }
      if (urls[HomeyAPI2.DISCOVERY_STRATEGIES.CLOUD]) {
        ...
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.CLOUD].catch(
          (err) => this.__debug(`Ping ${HomeyAPI2.DISCOVERY_STRATEGIES.CLOUD} Error:`, err && err.message)
        );
      }
      if (urls[HomeyAPI2.DISCOVERY_STRATEGIES.REMOTE_FORWARDED]) {
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.REMOTE_FORWARDED] = ping(
          HomeyAPI2.DISCOVERY_STRATEGIES.REMOTE_FORWARDED,
          2e3
        );
        pings[HomeyAPI2.DISCOVERY_STRATEGIES.REMOTE_FORWARDED].catch(
          (err) => this.__debug(`Ping ${HomeyAPI2.DISCOVERY_STRATEGIES.REMOTE_FORWARDED} Error:`, err && err.message)
        );
      }
    ...
    async refreshSession() {
      if (!this.__refreshSessionPromise) {
        ...
        this.__refreshSessionPromise.catch((err) => {
    ...
    async __handshakeClient() {
        ...
        return new Promise((resolve, reject) => {
          ...
          this.__homeySocket.once("connect_error", (err) => {
            ...
            if (err) {
              ...
              if (typeof err === "object") {
                return reject(new HomeyAPIError3({ error_description: err.message }, err.statusCode || err.code));
              }
      ...
      const handshakeClient = async (token2) => {
        return new Promise((resolve, reject) => {
          this.__socket.emit(
            "handshakeClient",
            {
      ...
      const token = this.__token;
      try {
        const result = await Util3.timeout(
  ...
  __publicField(HomeyAPIV3, "MANAGERS", {
    ...
    ManagerZones: ManagerZones2
  });
  __publicField(HomeyAPIV3, "DEFAULT_TIMEOUT", 1e3 * 10);
  __publicField(HomeyAPIV3, "HANDSHAKE_TIMEOUT", 1e3 * 10);
  __publicField(HomeyAPIV3, "SUBSCRIBE_TIMEOUT", 1e3 * 10);
...
let API$1 = (_h = class {
  constructor({ baseUrl, debug: debug2 = false, secret = null } = {}) {
  ...
  async onCallRequestExecute({ request }) {
    ...
    const result = await Util$1.fetch(
      request.url,
      {
  ...
  async onCallResponseNotOK({
    ...
    throw new APIError$2(message, statusCode);
  }
...
let HomeyAPIV1$1 = class HomeyAPIV1 extends HomeyAPI {
  constructor({ properties, api, debug: debug2 }) {
    super({ properties, api, debug: debug2 });
...
let APIErrorNotFound$1 = class APIErrorNotFound extends APIError$1 {
  constructor(message, statusCode = 404) {
    super(message, statusCode);
  }
};
var APIErrorNotFound_1 = APIErrorNotFound$1;
const APIDefinition2 = APIDefinition_1;
const Homey$1 = Homey_1;
const Device4 = Device_1;
const APIErrorNotFound2 = APIErrorNotFound_1;
let User$1 = class User extends APIDefinition2 {
  ...
  getHomeyById(id) {
    ...
    if (!homey) {
      throw new APIErrorNotFound2(`Homey Not Found: ${id}`);
    }
    return homey;
  }
  /**
...
class AthomCloudAPI extends API {
  ...
  */
  ...
  getLoginUrl({
    ...
    return `${this.baseUrl}/oauth2/authorise?${Util2.encodeUrlSearchParams(params)}`;
  }
  async getDelegatedLoginUrl(args = {}) {
    ...
    return args.baseUrl + seperator + Util2.encodeUrlSearchParams(params);
  }
  /**
  ...
  */
  async authenticateWithClientCredentials() {
    ...
    const response = await Util2.fetch(`${this.baseUrl}/oauth2/token`, {
      body: Util2.encodeUrlSearchParams(params),
      method: "post",
      headers: {
    ...
    try {
      ...
      throw new APIError2(`Invalid response from server: ${response.text()}`, response.status);
    }
    if (!response.ok) {
