import { s as safe_not_equal, p as binding_callbacks, f as element, a as space, l as text, g as claim_element, h as children, c as claim_space, v as get_svelte_dataset, m as claim_text, d as detach, j as attr, i as insert_hydration, w as append_hydration, r as listen, K as add_flush_callback, D as run_all, L as createEventDispatcher, G as head_selector, u as component_subscribe, o as onMount, x as noop, n as set_data } from "../chunks/scheduler.eb13839d.js";
import { S as SvelteComponent, i as init, f as bind, b as create_component, d as claim_component, m as mount_component, a as transition_in, t as transition_out, e as destroy_component, c as check_outros, g as group_outros } from "../chunks/index.b52a7f1f.js";
import { g as goto } from "../chunks/navigation.6eae7c83.js";
import { e as base } from "../chunks/singletons.2584eb3f.js";
import { p as page } from "../chunks/stores.ea1ed521.js";
import { o as v4, j as homey, p as stores, k as dashboards$1, a as alerts } from "../chunks/alerting.aeabfc87.js";
import { d as dashboards, s as saveDashboard, a as deleteDashboard } from "../chunks/localstorage.672ead33.js";
import { e as editing } from "../chunks/editing.4c31298d.js";
import { T as TextPicker, I as IconPicker, i as info, a as info$1, W as Widget, b as WidgetEditor, S as StoreDialog } from "../chunks/StoreDialog.134a2e47.js";
import { m as mdiViewDashboard } from "../chunks/utils.01552eec.js";
import { D as DashboardListHero } from "../chunks/DashboardListHero.89d47a8e.js";
...
function cleanV1(dashboard) {
  if (dashboard.dashboards !== void 0) {
    delete dashboard.dashboards;
  }
  if (dashboard.templates !== void 0) {
    delete dashboard.templates;
  }
  if (dashboard.backgroundImage !== void 0) {
    delete dashboard.backgroundImage;
  }
  if (dashboard.items !== void 0) {
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      t = claim_space(nodes);
      div = claim_element(nodes, "DIV", { class: true, "data-theme": true });
      var div_nodes = children(div);
      if_block.l(div_nodes);
      div_nodes.forEach(detach);
      this.h();
    ...
    h() {
      ...
      attr(div, "data-theme", div_data_theme_value = /*dashboard*/
      ((_a = ctx[1]) == null ? void 0 : _a.theme) ?? "");
    },
    m(target, anchor) {
      insert_hydration(target, t, anchor);
      insert_hydration(target, div, anchor);
    ...
    p(ctx2, [dirty]) {
      ...
      if (!current || dirty & /*dashboard*/
      2 && div_data_theme_value !== (div_data_theme_value = /*dashboard*/
      ((_a = ctx2[1]) == null ? void 0 : _a.theme) ?? "")) {
        attr(div, "data-theme", div_data_theme_value);
      }
    },
    i(local) {
      if (current)
